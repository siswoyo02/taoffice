    ...
    <center>
        <div class="container-fluid">
            <div class="card card-outline card-primary col-lg-4">
                <div class="p-4">
                    <form method="post" action="{{ url('/client/insert') }}">
                        @csrf
                            <div class="form-group">
                                <label for="nama_client" class="float-left">Nama client</label>
                                <input type="text" class="form-control @error('nama_client') is-invalid @enderror" id="nama_client" name="nama_client" autofocus value="{{ old('nama_client') }}">
                                @error('nama_client')
