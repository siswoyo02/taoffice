    ...
    <center>
        <div class="container-fluid">
            <div class="card card-outline card-primary col-lg-4">
                <div class="p-4">
                    <form method="post" action="{{ url('/srtkeluar/update/'.$data_suratkeluar->id) }}">
                        @method('put')
                        @csrf
                            <div class="form-group">
                                <label for="nama_suratkeluar" class="float-left">Nama suratkeluar</label>
                                <input type="text" class="form-control @error('nama_suratkeluar') is-invalid @enderror" id="nama_suratkeluar" name="nama_suratkeluar" autofocus value="{{ old('nama_suratkeluar', $data_suratkeluar->nama_suratkeluar) }}">
