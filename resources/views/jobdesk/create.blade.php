    ...
    <center>
        <div class="container-fluid">
            <div class="card card-outline card-primary col-lg-4">
                <div class="p-4">
                    <form method="post" action="{{ url('/jobdesk/insert') }}">
                        @csrf
                            <div class="form-group">
                                <label for="nama_client" class="float-left">Nama jobdesk</label>
                                <input type="text" class="form-control @error('nama_jobdesk') is-invalid @enderror" id="nama_jobdesk" name="nama_jobdesk" autofocus value="{{ old('nama_jobdesk') }}">
                                @error('nama_jobdesk')
